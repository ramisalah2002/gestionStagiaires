...
>>>>>>> 476b1dc124db86cb35ab6790c56ae9d718711972
        ...
        <div className="stagiaire-modal-overlay">
          <form className="stagiaire-modal-content">
            <div className="stagiaire-modal-header">
              ...
              <Link onClick={closeModal} className='stagiaire-close-link'><FontAwesomeIcon icon={faClose} /></Link>
            </div>
            ...
            <div className='form-group'>
              ...
              <div className='email-container'>
                ...
                <div className='password-container'>
                  <input disabled value={generatedPassword || "Votre mot de passe sera généré"}/>
                  <Link className='generate-password' onClick={generatePassword}>Génerer</Link>
                </div>
              </div>
            </div>
            <div className='form-group'>
              <div className='nom-container'>
                ...
                <input type="number" min={0} placeholder='Entrez le téléphone du stagiaire'/>
              </div>
              <div className='prenom-container'>
            ...
            <div className='save-container'>
              <Link onClick={closeModal} className='annuler-link'>Annuler</Link>
